    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 43, 4, 965);
    			add_location(br, file$2, 44, 4, 1014);
    			attr_dev(input, "type", "file");
    			attr_dev(input, "id", "fileInput");
    			add_location(input, file$2, 45, 4, 1026);
    			add_location(div0, file$2, 42, 2, 954);
    			attr_dev(div1, "id", "fileDrop");
    			attr_dev(div1, "class", "svelte-taa5e1");
    			add_location(div1, file$2, 48, 2, 1078);
    			attr_dev(div2, "class", "container svelte-taa5e1");
    			add_location(div2, file$2, 41, 0, 927);
    			add_location(button, file$2, 53, 0, 1220);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
